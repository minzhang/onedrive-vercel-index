...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'zhangmindotnet@msn.com',
  ...
  protectedRoutes: ['/Private','/another private folder/private'],
